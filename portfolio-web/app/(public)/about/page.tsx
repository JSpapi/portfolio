  ...
  return (
    <div className="wrap max-w-4xl pt-14 sm:pt-20">
      ...
      <p className="mt-6 max-w-2xl text-base leading-relaxed text-foreground-dim sm:text-lg">
        I&apos;m a full-stack engineer who lives in TypeScript — <span className="text-foreground">Node.js
        ...
        on the tech team at <span className="text-foreground">Gross</span>, one of
          ...
          {timeline.map((t, i) => (
            ...
            >
              ...
              <div className="mt-1 sm:mt-0">
                ...
                <p className="mt-1 text-foreground-dim">{t.detail}</p>
              </div>
            </li>
          ))}
        </ol>
      ...
      <section className="mt-14 overflow-hidden rounded-2xl border border-accent/30 bg-gradient-to-br from-accent/[0.08] to-transparent p-6 sm:mt-20 sm:p-10">
        ...
        <p className="mt-3 max-w-xl text-foreground-dim">
