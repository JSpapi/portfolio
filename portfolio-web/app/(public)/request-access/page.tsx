  ...
  return (
    <div className="wrap max-w-xl pt-14 sm:pt-20">
      ...
      <ul className="mt-6 space-y-2 font-mono text-sm text-foreground-faint">
        <li>
          <span className="text-accent">01</span> you submit this form
        </li>
        <li>
          <span className="text-accent">02</span> I get a notification and review
          it
        </li>
        <li>
          <span className="text-accent">03</span> on approval, you get a private
          link by email
        </li>
      </ul>
